...
DIR_nonCP     = f'{root_dir}/FILES_nonCP/tasmax/rcp85'
DIR_nonCP_hfls= f'{root_dir}/FILES_nonCP/hfls/rcp85'
DIR_nonCP_p90 = f'{root_dir}/FILES_nonCP/tasmax/rcp85/p90'
...
filename_p90 = [ \
 f'tasmax_EUR-15_NorESM1-ME_rcp85_r1i1p1_AUTH-MC-WRF381D_fpsconv-x0n1-v1_day.nc', \
 f'tasmax_EUR-11_CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CLMcom-CCLM4-8-17_cordex-x0n1-v1_day.nc', \
 f'tasmax_EUR-11_ICHEC-EC-EARTH_rcp85_r12i1p1_CLMcom-CMCC-CCLM5-0-9_v1_day.nc', \
 f'tasmax_EUR-11_CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CNRM-ALADIN63_v2_day.nc', \
 f'tasmax_EUR-11_MPI_rcp85_r1i1p1_COSMO-pompa_5.0_2019.1_day.nc', \
 f'tasmax_EUR-15_SMHI-EC-EARTH_rcp85_r12_FZJ-IBG3-WRF381CA_v1_day.nc', \
 f'tasmax_ALP-12_ICHEC-EC-EARTH_rcp85_r12i1p1_HCLIMcom-HCLIM38-ALADIN_v1_day.nc', \
 f'tasmax_EUR-11_MOHC-HadGEM2-ES_rcp85_r1i1p1_ICTP-RegCM4-7_fpsconv-x2yn1-v1_day.nc' ,\
 f'tasmax_EUR-11_MPI-M-MPI-ESM-LR_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_day.nc', \
 f'tasmax_WCE-11_KNMI-EC-EARTH_rcp85_r4i1p1_KNMI-RACMO23E_v1_day.nc',\
 f'tasmax_EUR-11_MOHC-HadGEM2-ES_rcp85_r1i1p1_MOHC-HadREM3-GA7-05_v1_day.nc', \
 ]

filename_hfls = [ \
f'hfls_EUR-15_NorESM1-ME_rcp85_r1i1p1_AUTH-MC-WRF381D_fpsconv-x0n1-v1_day_JJA.nc',\
f'hfls_EUR-11_CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_day_JJA.nc', \
f'hfls_EUR-11_ICHEC-EC-EARTH_rcp85_r12i1p1_CLMcom-CMCC-CCLM5-0-9_v1_day_JJA.nc', \
f'hfls_EUR-11_CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CNRM-ALADIN63_v2_day_JJA.nc', \
f'hfls_EUR-11_MPI_rcp85_r1i1p1_COSMO-pompa_5.0_2019.1_day_JJA.nc', \
f'hfls_EUR-15_SMHI-EC-EARTH_rcp85_r12i1p1_FZJ-IDL-WRF381CA_fpsconv-x1n2-v1_day_JJA.nc', \
f'hfls_ALP-12_ICHEC-EC-EARTH_rcp85_r12i1p1_HCLIMcom-HCLIM38-ALADIN_v1_day_JJA.nc', \
f'hfls_EUR-11_MOHC-HadGEM2-ES_rcp85_r1i1p1_ICTP-RegCM4-7_fpsconv-x2yn1-v1_day_JJA.nc', \
f'hfls_EUR-11_MPI-M-MPI-ESM-LR_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_day_JJA.nc', \
f'hfls_WCE-11_KNMI-EC-EARTH_rcp85_r4i1p1_KNMI-RACMO23E_v1_day_JJA.nc', \
f'hfls_EUR-11_MOHC-HadGEM2-ES_rcp85_r1i1p1_MOHC-HadREM3-GA7-05_v1_day_JJA.nc', \
]

filename_tasmax_rcp85_out = [ \
f'tasmax_EUR-15_NorESM1-ME_rcp85_r1i1p1_AUTH-MC-WRF381D_fpsconv-x0n1-v1_day_on_rcp85_clima_JJA.nc', \
f'tasmax_EUR-11_CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CLMcom-CCLM4-8-17_cordex-x0n1-v1_day_on_rcp85_clima_JJA.nc', \
f'tasmax_EUR-11_ICHEC-EC-EARTH_rcp85_r12i1p1_CLMcom-CMCC-CCLM5-0-9_v1_day_on_rcp85_clima_JJA.nc', \
f'tasmax_EUR-11_CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CNRM-ALADIN63_v2_day_on_rcp85_clima_JJA.nc', \
f'tasmax_EUR-11_MPI_rcp85_r1i1p1_COSMO-pompa_5.0_2019.1_day_on_rcp85_clima_JJA.nc', \
f'tasmax_EUR-15_SMHI-EC-EARTH_rcp85_r12i1p1_FZJ-IDL-WRF381CA_fpsconv-x1n2-v1_day_on_rcp85_clima_JJA.nc', \
f'tasmax_ALP-12_ICHEC-EC-EARTH_rcp85_r12i1p1_HCLIMcom-HCLIM38-ALADIN_v1_day_on_rcp85_clima_JJA.nc', \
f'tasmax_EUR-11_MOHC-HadGEM2-ES_rcp85_r1i1p1_ICTP-RegCM4-7_fpsconv-x2yn1-v1_day_on_rcp85_clima_JJA.nc', \
f'tasmax_EUR-11_MPI-M-MPI-ESM-LR_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_day_on_rcp85_clima_JJA.nc', \
f'tasmax_WCE-11_KNMI-EC-EARTH_rcp85_r4i1p1_KNMI-RACMO23E_v1_day_on_rcp85_clima_JJA.nc', \
f'tasmax_EUR-11_MOHC-HadGEM2-ES_rcp85_r1i1p1_MOHC-HadREM3-GA7-05_v1_day_on_rcp85_clima_JJA.nc', \
]
...
tasmax_ifile     = f'/users_home/cmcc/ls21622/tmp/tasmax_{MODELS[M]}_{RES}.nc'
tasmax_p90_ifile = f'/users_home/cmcc/ls21622/tmp/tasmax_p90_{MODELS[M]}_{RES}.nc' 
lsmask_ifile     = f'/users_home/cmcc/ls21622/tmp/lsmask_{MODELS[M]}_{RES}.nc'
tasmax_y_ifile   = f'/users_home/cmcc/ls21622/tmp/tasmax_{MODELS[M]}_Y_{RES}.nc'
hfls_ifile       = f'/users_home/cmcc/ls21622/tmp/hfls_{MODELS[M]}_{RES}.nc'
hfls_y_ifile     = f'/users_home/cmcc/ls21622/tmp/hfls_{MODELS[M]}_Y_{RES}.nc'
...
if MODELS[M] == 'UKMO' : 
    time = out_nc1.createDimension('time',ntim-1)
else : 
