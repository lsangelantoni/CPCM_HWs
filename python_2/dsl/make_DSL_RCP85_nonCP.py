...
DIR = f'{root_dir}/FILES_nonCP/pr/rcp85'
...
filename = [ \
f'pr_EUR-15_NorESM1-ME_rcp85_r1i1p1_AUTH-MC-WRF381D_fpsconv-x0n1-v1_day_JJA.nc', \
f'pr_EUR-11_CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CLMcom-CCLM4-8-17_cordex-x0n1-v1_day_JJA.nc', \
f'pr_EUR-11_ICHEC-EC-EARTH_rcp85_r12i1p1_CLMcom-CMCC-CCLM5-0-9_v1_day_JJA.nc', \
f'pr_EUR-11_CNRM-CERFACS-CNRM-CM5_rcp85_r1i1p1_CNRM-ALADIN63_v2_day_JJA.nc', \
f'pr_EUR-11_MPI_rcp85_r1i1p1_COSMO-pompa_5.0_2019.1_day_JJA.nc', \
f'pr_EUR-15_SMHI-EC-EARTH_rcp85_r12i1p1_FZJ-IDL-WRF381DA_fpsconv-x1n2-v1_day_JJA.nc',\
f'pr_ALP-12_ICHEC-EC-EARTH_rcp85_r12i1p1_HCLIMcom-HCLIM38-ALADIN_v1_day_JJA.nc', \
f'pr_EUR-11_MOHC-HadGEM2-ES_rcp85_r1i1p1_ICTP-RegCM4-7_fpsconv-x2yn1-v1_day_JJA.nc', \
f'pr_EUR-11_MPI-M-MPI-ESM-LR_rcp85_r1i1p1_CLMcom-CCLM4-8-17_v1_day_JJA.nc', \
f'pr_WCE-11_KNMI-EC-EARTH_rcp85_r4i1p1_KNMI-RACMO23E_v1_day_JJA.nc',\
f'pr_EUR-11_MOHC-HadGEM2-ES_rcp85_r1i1p1_MOHC-HadREM3-GA7-05_v1_day_JJA.nc', \
]
...
#plt.show()
plt.savefig(f'./figures/{MODELS[M]}_nonCP_rcp85_test.png')
# ---------------
