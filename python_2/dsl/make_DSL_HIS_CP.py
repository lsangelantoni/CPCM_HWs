...
DIR = f'{root_dir}/FILES_CP/pr/historical'
...
filename = [ \
'pr_ALP-3_NorESM1-ME_historical_r1i1p1_BCCR-WRF381DA_fpsconv-x1n2-v1_day_JJA.nc',\
'pr_ALP-3_CNRM-CERFACS-CNRM-CM5_historical_r1i1p1_CLMcom-BTU-CCLM5-0-14_fpsconv-x2yn2-v1_day_JJA.nc', \
'pr_ALP-3_ICHEC-EC-EARTH_historical_r12i1p1_CLMcom-CMCC-CCLM5-0-9_x2yn2v1_day_JJA.nc', \
'pr_ALP-3_CNRM-CERFACS-CNRM-CM5_historical_r1i1p1_CNRM-AROME41t1_x2yn2v1_day_JJA.nc', \
'pr_ALP-3_MPI_historical_r1i1p1_COSMO-pompa_5.0_2019.1_day_JJA.nc', \
'pr_ALP-3_SMHI-EC-EARTH_historical_r12i1p1_FZJ-IDL-WRF381DA_fpsconv-x1n2-v1_day_JJA.nc', \
'pr_ALP-3_ICHEC-EC-EARTH_historical_r12i1p1_HCLIMcom-HCLIM38-AROME_fpsconv-x2yn2-v1_day_JJA.nc', \
'pr_ALP-3_MOHC-HadGEM2-ES_historical_r1i1p1_ICTP-RegCM4-7_fpsconv-x2yn2-v1_day_JJA.nc', \
'pr_ALP-3_MPI-M-MPI-ESM-LR_historical_r1i1p1_CLMcom-KIT-CCLM5-0-15_fpsconv-x2yn2-v1_day_JJA.nc', \
'pr_ALP-3_KNMI-EC-EARTH_historical_r14i1p1_KNMI-HCLIM38h1-AROME_fpsconv-x2yn2-v1_day_JJA.nc', \
'pr_ALP-3_HadGEM3-GC3.1-N512_historical_r1i1p1_HadREM3-RA-UM10.1_fpsconv-x0n1-v1_day_JJA.nc', \
'pr_ALP-3_MPI-M-MPI-ESM-LR_historical_r1i1p1_CLMcom-JLU-CCLM5-0-15_fpsconv-x0n1-v1_day_JJA.nc'\
]
...
#plt.show()
plt.savefig(f'./figures/{MODELS[M]}_CP_his_test.png')
# ---------------
