...
filename = [ \
f'pr_day_CNRM-CM5_rcp85_r1i1p1_box_2090_2099.nc', \
f'pr_day_EC-EARTH_rcp85_r12i1p1_2090_2099_box.nc', \
f'pr_day_HadGEM2-ES_rcp85_r1i1p1_box_2090_2099.nc', \
f'pr_day_MPI-ESM-LR_rcp85_r1i1p1_box_2090_2099.nc', \
f'pr_day_NorESM1-M_rcp85_r1i1p1_box_2090_2099.nc', \
]
...
if MODELS[M] != 'CNRM-CM5_r1i1p1' : #'HadGEM2-ES_r1i1p1' :
    ds_out = xr.open_dataset(f'/scratch/lorenzosangelantoni/GCMs/CNRM-CM5_r1i1p1/surface/pr_day_CNRM-CM5_rcp85_r1i1p1_box_2090_2099.nc')
...
# -------------------------------------------------------------------
plt.clf()
levels = np.linspace(2,30,14)
my_cmap = 'jet'
plt.figure(figsize=(12,4))
data_crs = ccrs.PlateCarree() # Define transform
ax = plt.axes(projection=ccrs.PlateCarree()) # Define projection 
plot = ds_out.DSL_mean.mean('time').plot(ax=ax, x='lon', y='lat',transform=ccrs.PlateCarree(),levels=levels,
                                                        cmap=my_cmap,cbar_kwargs={"label": 'days'})
